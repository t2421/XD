...
class HelloForm extends React.Component {
    ...
    render() {
        return React.createElement(
            ...
            React.createElement(
                "a",
                { href: "https://adobexdplatform.com/", target: "_blank" },
            ...
            React.createElement(
                ...
                React.createElement("input", { className: "input_text", onChange: this.onInputChange })
            ),
            React.createElement("input", { type: "checkbox", checked: this.state.isCheck, onChange: this.onCheckboxChange }),
            React.createElement("input", { type: "range", min: "0", max: "100", value: this.state.range, onChange: this.onRangeChange }),
            React.createElement(
                "p",
                null,
